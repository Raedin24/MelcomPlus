...
object CategoryRepository {
    ...
    fun loadFromAssets(context: Context) {
        val productCsv = context.assets.open("product_listing.csv")
        val categoryCsv = context.assets.open("catalog_categories.csv")
        val subcategoryCsv = context.assets.open("catalog_subcategories.csv")

        CsvProcessor.loadData(productCsv, categoryCsv, subcategoryCsv)
    }
}
...
//                    price = 128.99,
//                    imageUrl = "https://demo8.1edhour.in/media/products/13869.png"
//                ),
//                Product(
